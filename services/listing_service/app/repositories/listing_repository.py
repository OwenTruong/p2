    ...
    def save(self, listing: Listing) -> Listing:
        insert_query = f"""
            INSERT INTO {self._table_name} (
                host_id, title, description, url, price_per_night, 
        ...
        update_query = f"""
            ...
            SET title = %s, description = %s, url = %s, price_per_night = %s, 
        ...
        if listing.listing_id == None:
            return self._execute_fetch_one(
                ...
                Listing,
                values=[
                    listing.host_id, listing.title, listing.description, listing.url, listing.price_per_night,
            ...
            return self._execute_fetch_one(
                ...
                Listing,
                values=[
                    listing.title, listing.description, listing.url, listing.price_per_night,
